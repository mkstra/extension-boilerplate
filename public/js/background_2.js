...
const sendToActiveTab = message => new Promise(function(resolve) {
...
const getActiveTab = () => new Promise(function(resolve){
    chrome.tabs.query(
...
const updateActiveTabState = async () => {
...
const updateLocal = async (domain, tabId) => {
    console.log(domain, tabId)
    console.log(localStorage, "store")
    // const apps = JSON.parse(localStorage["apps"]);
    const res = await sendToActiveTab({action: "fat yolo"})
